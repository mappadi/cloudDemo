...
public class AMDOnboardingScreen {
	public static By objEnv = By.xpath("//*[@text='CONTINUE']");
	public static By objAccept = By.xpath("//*[@text='Allow only while using the app']");
	public static By objCountry = By.xpath("//*[@text='India +91']");
